...
const tr = {
  ...
  showcase: {
    ...
    description: "Uygulamanın birebir görünümleri: panel, stok, teklifler, servisler ve finans.",
    langBtn: "EN",
    statuses: { paid: "Ödendi", pending: "Bekliyor" },
    tabs: ["Ana Sayfa", "Stok", "Servis", "Teklif", "Müşteriler", "Plan", "Finans", "Ayarlar"],
    profil: {
      title: "Profil",
      name: "Ad Soyad",
      email: "E-posta",
...
version: "Sürüm",
    ...
    stock: {
      title: "Stok Yönetimi",
      subtitle: "Ürün stoklarını yönetin ve e-faturaları içe aktarın",
      ...
      noLowStock: "Kritik seviyede ürün yok",
      allCount: "4 ürün",
      lowCount: "2 ürün",
      previous: "Önceki",
      next: "Sonraki",
    ...
    finans: {
      title: "Finans Takibi",
      subtitle: "Mali durumunuzu ve servis ödemelerinizi yönetin",
      overview: "FİNANS GENEL GÖRÜNÜM",
      chartTitle: "Finans Akışı",
      chartNote: "Ağustos 2026 · aylık bazda",
      year: "Yıl",
      month: "Ay",
      all: "Tümü",
      tryNote: "Tüm tutarlar TCMB kurları ile Türk Lirasına çevrilir",
      signNote: "+ eklenen (varlık/gelir), - düşülen (gider)",
      stock: "Stok Değeri",
      stockSub: "Mevcut envanter",
      expense: "Giderler",
      expenseSub: "Fatura alımları",
      pending: "Servislerden Beklenen",
      pendingSub: "6 bekleyen servis",
      paid: "Şu Anda Alınan",
      paidSub: "12 ödemeli servis",
      net: "Genel Mali Durum",
      netTotal: "₺248.750",
      perCurrency: "Para Birimine Göre Dağılım",
      curSrc: "Kaynak",
      ratesNote: "TCMB kurlarıyla hesaplanmıştır",
    },
    forms: {
...
panel: {
      ...
      stockDesc: "Ürün stoklarınızı yönetin",
...
const en: Dictionary = {
  ...
  showcase: {
    ...
    description: "Faithful views of the app: overview, stock, quotes, services and finance.",
    langBtn: "TR",
    statuses: { paid: "Paid", pending: "Pending" },
    tabs: ["Home", "Stock", "Services", "Quotes", "Customers", "Schedule", "Finance", "Settings"],
    profil: {
      title: "Profile",
      name: "Full Name",
      email: "Email",
...
version: "Version",
    ...
    stock: {
      title: "Stock Management",
      subtitle: "Manage product stock and import e-invoices",
    ...
    finans: {
      title: "Finance",
      subtitle: "Manage financial position and service payments",
      overview: "FINANCE OVERVIEW",
      chartTitle: "Finance Flow",
      chartNote: "August 2026 · monthly basis",
      year: "Year",
      month: "Month",
      all: "All",
      tryNote: "All amounts converted to Turkish Lira using TCMB rates",
      signNote: "+ added (asset/income), - deducted (expense)",
      stock: "Stock Value",
      stockSub: "Current inventory",
      expense: "Expenses",
      expenseSub: "Invoice purchases",
      pending: "Incoming from Services",
      pendingSub: "6 pending services",
      paid: "Currently Received",
      paidSub: "12 paid services",
      net: "Overall Financial Position",
      netTotal: "₺248,750",
      perCurrency: "Breakdown by Currency",
      curSrc: "Source",
      ratesNote: "Calculated using TCMB rates",
    },
    forms: {
      qNewQuote: "New Quote",
...
panel: {
      ...
      stockDesc: "Manage your product stock",
