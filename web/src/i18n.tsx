...
const tr = {
  ...
  showcase: {
    ...
    title: "Panel, cebinizde",
    description:
      "Uygulamadan örnek görünümler: genel durum, teklifler, servisler ve müşteriler — hepsi tek panelde.",
    statuses: { paid: "Ödendi", pending: "Bekliyor", approved: "Onaylandı" },
    tabs: ["Ana Sayfa", "Servis", "Teklif", "Müşteriler", "Ayarlar"],
    panel: {
      label: "Panel",
      greeting: "Hoş Geldiniz",
      subtitle: "Size nasıl yardımcı olabiliriz?",
      cards: ["Servisler", "Teklifler", "Müşteriler"],
      values: ["3", "2", "24"],
      payment: "ÖDEME DURUMU",
      received: "Alınan Ödeme · ₺12.500",
      pendingAmount: "Bekleyen Ödeme · ₺4.200",
      today: "Bugün · 2 iş planlandı",
      recent: "SON SERVİSLER",
      rows: ["Klima Bakım", "Kombi Montaj"],
      info: ["Ayşe Yılmaz", "Mehmet Kaya"],
      states: ["paid", "pending"],
    },
    quotes: {
      label: "Teklifler",
      search: "Teklif ara...",
      currency: "USD kur 34,20 · TCMB",
      rows: ["Klima Bakım (Yıllık)", "Kombi Tamiri", "Doğalgaz Testi"],
      info: ["Ayşe Yılmaz", "Mehmet Kaya", "Zeynep Demir"],
      amounts: ["₺3.450", "₺2.190", "₺850"],
      states: ["approved", "pending", "approved"],
    },
    services: {
      label: "Servisler",
      search: "Servis ara...",
      rows: ["Klima Bakım", "Kombi Montaj", "Arıza Onarım"],
      info: ["Ayşe Yılmaz · 12.09.2026", "Mehmet Kaya · 11.09.2026", "Ali Vural · 10.09.2026"],
      states: ["paid", "pending", "paid"],
    },
    customers: {
      label: "Müşteriler",
      search: "Müşteri ara...",
      rows: ["Ayşe Yılmaz", "Mehmet Kaya", "Zeynep Demir"],
      info: ["0532 000 00 00", "0505 000 00 00", "0542 000 00 00"],
      tags: ["Kurumsal", "Bireysel", "Bireysel"],
    },
  },
} as const;
...
const en: Dictionary = {
  ...
  showcase: {
    ...
    title: "The panel, in your pocket",
    description:
      "Sample views from the app: overview, quotes, services and customers — all in one panel.",
    statuses: { paid: "Paid", pending: "Pending", approved: "Approved" },
    tabs: ["Home", "Services", "Quotes", "Customers", "Settings"],
    panel: {
      label: "Overview",
      greeting: "Welcome",
      subtitle: "How can we help you?",
      cards: ["Services", "Quotes", "Customers"],
      values: ["3", "2", "24"],
      payment: "PAYMENT STATUS",
      received: "Received · ₺12,500",
      pendingAmount: "Pending · ₺4,200",
      today: "Today · 2 jobs planned",
      recent: "RECENT SERVICES",
      rows: ["AC Maintenance", "Boiler Installation"],
      info: ["Ayşe Yılmaz", "Mehmet Kaya"],
      states: ["paid", "pending"],
    },
    quotes: {
      ...
      currency: "USD rate 34.20 · TCMB",
      rows: ["AC Maintenance (Annual)", "Boiler Repair", "Gas Test"],
      info: ["Ayşe Yılmaz", "Mehmet Kaya", "Zeynep Demir"],
      amounts: ["₺3,450", "₺2,190", "₺850"],
      states: ["approved", "pending", "approved"],
    },
    services: {
      ...
      rows: ["AC Maintenance", "Boiler Installation", "Repair"],
      info: ["Ayşe Yılmaz · 12.09.2026", "Mehmet Kaya · 11.09.2026", "Ali Vural · 10.09.2026"],
      states: ["paid", "pending", "paid"],
    },
    customers: {
      ...
      rows: ["Ayşe Yılmaz", "Mehmet Kaya", "Zeynep Demir"],
      info: ["0532 000 00 00", "0505 000 00 00", "0542 000 00 00"],
      tags: ["Corporate", "Individual", "Individual"],
    },
  },
};
